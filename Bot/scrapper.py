...
def Result_Bot_function(RegistrationNo, url):
    ...
    if str(status) != 'None':
        ...
        # SEMESTER WISE SGPA and Current CGPA
        ...
        header = ['Registration No', 'Student Name', 'College Code', 'College Name', 'Course Code',
                  'Course Name', 'SEM I', 'SEM II', 'SEM III', 'SEM IV', 'SEM V', 'SEM VI', 'SEM VII', 'SEM VIII', 'CGPA']
